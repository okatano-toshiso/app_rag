...
class AWSTranscribeTranscriber(AudioTranscriber):
    ...
    def transcribe(self, audio_file_path, user_id):
        ...
        custom_vocabulary_name = "dev-commapi-trnscrb-api-LineChatBot-CustomVocabularies"
...
class TranscriberFactory:
    @staticmethod
    def get_transcriber(api_transcribe_type, api_key=None, bucket_name=None, s3_key=None):
