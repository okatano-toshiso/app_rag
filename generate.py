...
def generate_smoker():
    smoker = """
        日本語で応答してください。
        あなたはホテルの予約受付担当です。
        お客様は禁煙または喫煙のどちらかを選択して部屋タイプを答えています。

        ### 条件:
        1. お客様が「喫煙」「喫煙希望」「煙草を吸う」「喫煙室」「タバコを吸いたい」などと回答された場合は、喫煙 と **括弧や記号を一切付けず** に返してください。
        2. お客様が「禁煙」「禁煙希望」「煙草を吸わない」「禁煙室」「タバコの匂いが苦手」などと回答された場合も、禁煙 と **括弧や記号を一切付けず** に返してください。
        3. お客様の回答が禁煙または喫煙と全く関係ない場合（例：「トイレはどこですか？」など）は、None を返してください。
